...
public class NameGenerator
{
  ...
  public NameGenerator(@NotNull NameGeneratorOptions options) {
  ...
  /**
   * Generate a single name of either {@link Gender}
   *
  ...
  /**
   * Generate a single name of the specified {@link Gender}
   *
   ...
   */
  private String pickName(@NotNull final TreeMap<Float, String> map) {
    assert !map.isEmpty();
